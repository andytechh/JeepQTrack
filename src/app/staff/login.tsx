...
const StaffLoginScreen: React.FC<Props> = ({
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#EAF7FF" }}>
      <StatusBar barStyle="light-content" backgroundColor="#0a1628" />

      {/* Header - Fixed height */}
      <LinearGradient
        colors={["#DFF5FF", "#BDEBFF", "#8DD8F7"]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0.5 }}
        style={{
          height: 220,
      ...
      <KeyboardAwareScrollView
        ref={scrollRef}
        style={{ flex: 1, backgroundColor: "#EAF7FF" }}
              ...
              return (
                <TouchableOpacity
                  ...
                  style={{
                    ...
                    borderWidth: 2,
                    borderColor: isSelected ? "#7DD3FC" : "#FFFFFF",
                    borderRadius: 20,
                    shadowColor: isSelected ? "#63BDEB" : "#8FB8C9",
                    shadowOffset: { width: 5, height: isSelected ? 7 : 5 },
                ...
                >
                  <View
                    style={{
                      ...
                      height: 48,
                      borderRadius: 18,
                      backgroundColor: isSelected ? "#D9F3FF" : "#EAF7FF",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
                  >
                  ...
                  {/* REAL RADIO BUTTON — no gray/tinted background */}
                  <View
                    style={{
                      width: 22,
                      height: 22,
                      borderRadius: 11,
                      borderWidth: 2,
                      borderColor: isSelected ? "#0EA5E9" : "#B8D2DE",
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          <View
            style={{
              ...
              borderColor: emailError ? "#EF9A9A" : "#FFFFFF",
              borderRadius: 18,
              paddingVertical: 14,
              paddingHorizontal: 16,
              shadowColor: "#8FBCCC",
          ...
          >
            <View
              style={{
                ...
                height: 20,
                borderRadius: 6,
                backgroundColor: rememberMe ? "#0EA5E9" : "#E1F0F6",
                alignItems: "center",
                justifyContent: "center",
      ...
      {/* Forgot Password Modal — isolated keyboard handling */}
      {showForgotPassword && (
        <View
          style={{
            position: "absolute",
            ...
            right: 0,
            bottom: 0,
            backgroundColor: "rgba(25,75,95,0.28)",
            zIndex: 100,
          }}
        >
          <KeyboardAvoidingView
